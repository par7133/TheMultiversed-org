# INSTALLATION
  ...
  Installing Simplicity is more straightforward than what it could appear..   
  
  First, if you use Nginx as reversed proxy just point the root of your web app to /path/to/YourSimplicity/Public   
  ...
  <li>Example of Nginx minimal configuration:
      ...
      server {   
        ...
        server_name yourSimplicity.com;
     
        root /var/www/YourSimplicity/Public;
        index index.php; 
  ...
  Apache instead should have DocumentRoot pointing to /path/to/YourSimplicity/Public .   
